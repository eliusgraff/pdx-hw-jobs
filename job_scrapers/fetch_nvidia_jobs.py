...
def fetch_nvidia_jobs():

    base_url = "https://jobs.nvidia.com/api/pcsx/search"
    params = {
        "domain": "nvidia.com",
        "location": "oregon",
        "start": 0,
        ...
        "filder_work_location_option": ["office","remote"],
        "filter_job_category": ["business development","research","operations","program manager", "engineering", "sales"]
    }
    ...
    while start < total:
        ...
        for job in positions:
            ...
            full_url = f"https://jobs.nvidia.com{position_url}"
